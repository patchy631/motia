---
title: "Middleware"
description: "Learn how to use middlewares in API steps"
---
## Using Middleware

[API Steps](/docs/concepts/step-types/api) in Motia support middleware functions that can be applied to requests before they reach your handler. Middleware functions are completely framework-agnostic and can perform tasks such as:
...
<Callout>Only applicable to [API Steps.](/docs/concepts/step-types/api)</Callout>
...
Using middlewares, you can cleanly separate shared operational logic from the business logic by intercepting requests before they reach the appropriate handlers.