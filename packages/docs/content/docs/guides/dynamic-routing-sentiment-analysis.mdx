---
title: "Route events based on LLM output"
description: "Build a Dynamic Sentiment Analysis Workflow and Route Events Based on LLM Output"
---

Sometimes you don't just want a **simple** "prompt => response" system. Instead, you want the LLM to decide how to proceed. Below is a minimal example that:
