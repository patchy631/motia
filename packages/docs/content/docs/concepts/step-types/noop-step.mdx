---
title: "NOOP Step"
description: "NOOP (No Operation) steps in Motia act as flexible placeholders or control points within a flow, useful for organizing, pausing, or conditionally branching workflows without executing logic."
---
